...
fn gamestate_menu_run(gamedata: *game_data.GameData) *game_data.GameData {
    ...
    gamedata.renderer.drawRect(SDL.Rectangle{ .x = 0, .y = 0, .width = 30, .height = 30 }) catch |err| {
...
pub const gamestate_menu = game_data.GameState{ .run = &gamestate_menu_run, .on_event = &gamestate_menu_onevent };
